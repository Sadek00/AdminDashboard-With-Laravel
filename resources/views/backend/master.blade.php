    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{url('add-subcategory')}}"><i class="fa fa-circle-o"></i> Add Sub Category</a></li>
            <li><a href="{{url('view-subcategory')}}"><i class="fa fa-circle-o"></i> View Sub Category</a></li>
            <li><a href="{{url('trashed-subcategory')}}"><i class="fa fa-circle-o"></i> Trashed</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
